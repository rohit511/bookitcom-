...
const Flite = () => {
    ...
    useEffect(() => {
        ...
        async function y() {
            const responce = await fetch('https://content.newtonschool.co/v1/pr/64ae94ad0a8068595eb03b01/flightsList?limit=10&page=1');
                                        ...
                                        <div className="fligth-detailsts">
                                            ...
                                            <div className="flight-conten">
                                                <div className="fligth-details">
                                                    <div style={{ color: "black", fontWeight: "bold" }}>From✈️</div>
                                                    
                                                    <div> {ele.from}</div></div>

                                                <div class="flight-wing">
                                                    <div className="fligth-details "><div style={{ color: "black", fontWeight: "bold" }}>To✈️</div><div>{ele.to}</div></div>
                                                    <div className="fligth-details"><div style={{ color: "black", fontWeight: "bold" }}>AirlineName✈️</div><div>{ele.airlineName}</div></div>
                                                    <div className="fligth-details">
                                                        <div style={{ color: "black", fontWeight: "bold" }}>DepartureTime✈️</div>
                                                        <div>{ele.departure.departureTime}</div></div>
                                                    <div className="fligth-details">
                                                        <div style={{ color: "black", fontWeight: "bold" }}>Return✈️</div>
                                                        <div>{ele.return.returnTime}</div></div>
                                                    <div className="fligth-details">
                                                        <div style={{ color: "black", fontWeight: "bold" }}>Via✈️</div>
                                                        <div>{ele.via}</div></div>
                                                    <div className="fligth-details">
                                                        <div style={{ color: "black", fontWeight: "bold" }}>Duration</div><div>{ele.duration}</div></div>
                                                    <div className="fligth-details">
                                                        <div style={{ color: "black", fontWeight: "bold" }}>Price</div><div>₹{ele.price}</div></div>
