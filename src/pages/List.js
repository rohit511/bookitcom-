      ...
      <div className="media-block">
        ...
        <div className="media-card">
          ...
          <div className="media-cotbox">
            ...
            <p style={{ color: "white" }} className="media-rating">8</p>
          ...
          <p className="media-cancel">You can cancel later.
          </p>
          <p><strong>price: </strong>₹1223</p>
          <button style={{margin:"10px 0"}} className="siCheckButton" onClick={Book} >Pay And book Now</button>
        ...
        <div className="media-card">
          ...
          <div className="media-cotbox">
            ...
            <p style={{ color: "white" }} className="media-rating">8.3</p>
        ...
        <div className="media-card">
          ...
          <div className="media-cotbox">
            <p>500m from center</p>
            <p style={{ color: "white" }} className="media-rating">8.8</p>
        ...
        <div className="media-card">
          ...
          <div className="media-cotbox">
            <p>500m from center</p>
            <p style={{ color: "white" }} className="media-rating">7.4</p>
