      ...
      <section style={{ marginBottom: "200px" }}>
        <div className="meal-header">
          <div className="mealHeading">
            <h1>
              Get <span>FreshFood </span>
              in a Easy Way
            </h1>
            <p className="meal-content">
              Single most intimate expression of our mothers’ love is cooking
              and pampering their kids with home cooked delicious meals . No
              matter, what we eat, where we eat, we can never replicate that
              special flavour of ‘Maa ke haath ka khana’, made for us with that
              magical ingredient called love along with the familiar sentiment
              of, “beta thoda aur kha le!”
            </p>
          </div>
        ...
        <div className="menu-cart">
          <div className="menu-content">
            ...
            <p className="menu-text">
              A burger is a patty of ground grilled allo and placed between two
            ...
            <button className="menu-btn" onClick={orderBook}>
              Order Now
            </button>
          </div>
          <div className="menu-content">
            ...
            <p className="menu-text">
              A sweet food . together and baking the mixture in the oven. a
              sweet baked food made from a dough or thick batter usually
              containing flour and sugar and often shortening.
            </p>

            <p className="menu-price">
              <strong>Price:</strong> ₹170
            </p>
          ...
          <div className="menu-content">
            ...
            <p className="menu-text">
              An Italian food made from flour, eggs and water, formed into
              different shapes, cooked, and usually served with a sauce .
              Various pata available .Nowadays, most products sold as pasta{" "}
            </p>
            <p className="menu-price">
          ...
          <div className="menu-content">
            ...
            <p className="menu-text">
              Hot dogs are made from the emulsified meat trimmings of chicken,
              beef, or pork. This meat mixture is blended with other ingredients
              into a batter-like substance.
            </p>
            <p className="menu-price">
          ...
          <div className="menu-content">
            ...
            <p className="menu-text">
              ...
              tomato, olives, mozzarella or other cheese.
            </p>

            <p className="menu-price">
              <strong>Price:</strong> ₹279
            </p>
          ...
          <div className="menu-content">
            ...
            <p className="menu-text">
              The origins of the word lasagne or lasagna can be traced back to
              Ancient Greece. What we know as lasagne or lasagna is derived from
              the word “laganon”.
            </p>
            <p className="menu-price">
              <strong>Price:</strong> ₹390
            </p>
          ...
          <div className="menu-content">
            ...
            <p className="menu-text">
              ...
              sugar, and flavourings. Frozen custard and French-type ice creams
              also contain eggs. Hundreds of flavours have been devised.{" "}
            </p>
            <p className="menu-price">
          ...
          <div className="menu-content">
            ...
            <p className="menu-text">
              Have you seen people drooling at the sight of cheese? If you are
              someone whose mouth starts watering literally at the mention of
              cheese, you have to try the cheese burst pizza.{" "}
            </p>
            <p className="menu-price">
          ...
          <div className="menu-content">
            ...
            <p className="menu-text">
              Like larger cakes, frosting and other cake decorations, such as
              sprinkles, are cupcakes. They are often sweet . Some specialized
              bakeries sell only cupcakes.
            </p>{" "}
            <p className="menu-price">
